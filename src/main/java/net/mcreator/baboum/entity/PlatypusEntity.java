...
package net.mcreator.baboum.entity;
...
import net.mcreator.baboum.procedures.SpeedProcedure;
import net.mcreator.baboum.init.BaboumModEntities;

public class PlatypusEntity extends Chicken implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);
	private boolean swinging;
	private long lastSwing;
	private String animationprocedure;

	public PlatypusEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BaboumModEntities.PLATYPUS.get(), world);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new TemptGoal(this, 2, Ingredient.of(Items.SALMON), false));
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1));
		this.goalSelector.addGoal(3, new RandomSwimmingGoal(this, 1, 40));
		this.goalSelector.addGoal(4, new RemoveBlockGoal(Blocks.OAK_LOG, this, 5, (int) 3));
	...
	public void baseTick() {
		super.baseTick();
		SpeedProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}
	...
	public static void init() {
		SpawnPlacements.register(BaboumModEntities.PLATYPUS.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	private <E extends IAnimatable> PlayState procedurePredicate(AnimationEvent<E> event) {
		this.animationprocedure = this.getPersistentData().getString("animation");
		if (!this.animationprocedure.equals("empty") && !this.animationprocedure.isEmpty()
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(PlatypusEntity.RemovalReason.KILLED);
		}
	}
